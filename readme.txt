...
> Microcode store (32 words by 32 bits deep) encoding the prime finding algorithm
> Control unit - contains a 4 deep 8-bit microinstruction pointer stack and can execute goto/gosub/wait/return etc commands. 
